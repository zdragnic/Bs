...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2017 at 04:49 PM
...
(4, 'Radiofrekvencija + vakum lica + tretman lica', 25),
(5, 'Spa manikir', 30),
(6, 'Nadogradnja noktiju', 25),
(7, 'Korekcijaa noktiju', 8),
...
(13, 'Nadogradnja noktiju + Šminkanje', 50),
...
('Čupanje obrva', 'Opis usluge.', 1),
('Farbanje obrva', 'Ovo je defaultni opis usluge. Stranica je u izradi. Pravi opisi naknadno ce biti dodani.', 0),
('Klasični pedikir', 'Opis usluge.', 1),
('Radiofrekvencija + vakum lica + tretman lica', 'Ovo wellness iskustvo\r\nnamijenjeno djevojkama\r\npored nježnog\r\nčišćenja lica također\r\nuključuje i njegujuću\r\nmasku za lice. Smiruju-\r\nća masaža lica upotpunjuje\r\novaj tretman lica.\r\n', 0);
