...
$brojac++;
print "<TR> 
<TD><input type='text' name='nazivf".$brojac."' value='".$fusluga->naziv."'></TD>
<TD><input type='text' name='cijenaf".$brojac."' value='".$fusluga->cijena."'></TD> 

<TD> <input type='submit' class='dugmemanje' name='brisanjef' value='X' onclick=\"document.getElementById('brojredaf').value='" .$brojac. "'\"> <input type='submit'class='dugmemanje' name='mijenjanjef' value='E' onclick=\"document.getElementById('brojredaf').value='" .$brojac. "'\"></TD> </TR>";   
} 
...
$brojac++;
print "<TR> 
<TD><input type='text' name='nazivk".$brojac."' value='".$kusluga->naziv."'></TD>
<TD><input type='text' name='cijenak".$brojac."' value='".$kusluga->cijena."'></TD> 

<TD> <input type='submit' class='dugmemanje' name='brisanjek' value='X' onclick=\"document.getElementById('brojredak').value='" .$brojac. "'\"> <input type='submit'class='dugmemanje' name='mijenjanjek' value='E' onclick=\"document.getElementById('brojredak').value='" .$brojac. "'\"></TD> </TR>";   
}
